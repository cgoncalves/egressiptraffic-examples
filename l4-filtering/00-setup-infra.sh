#!/bin/bash
# Sets up a Docker network and external server container for the L4 filtering example.
#
# Network layout:
#
#   ovn-worker (pod node)
...
#   +-------------------------+
#
# Only TCP traffic to port 8080 on the OAM network uses the EgressIP.
