...
- `eip-destination` with `trafficSelector`: routes traffic to `192.168.250.0/24` via `192.168.150.101` (secondary interface, priority 100)
...
- Traffic to `192.168.250.1:8080` should show source `192.168.150.101` (trafficSelector EgressIP)
